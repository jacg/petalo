            ...
            overlays = [
              ...
              rust-overlay.overlays.default (final: prev:
                let
                  ...
                  rust-nightly = final.rust-bin.nightly."2023-03-12";
                  rust-stable  = final.rust-bin.stable ."1.68.0"    ; # nix flake lock --update-input rust-overlay
                ...
                in
                  rec {
                    ...
                    rust-analyzer-preview = rust-analyzer-preview-on "2023-03-12";
                  })
            ];
          };
