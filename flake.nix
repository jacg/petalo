...
{
  description = "SimSET history file parser";
                ...
                rust-overlay.overlays.default (final: prev:
                  let
                    ...
                    rust-analyzer-preview-on = date:
                      final.rust-bin.nightly.${date}.default.override { # TO FIX ERROR: nix flake lock --update-input rust-overlay
