...
impl Scene {
    ...
    pub fn place_voxels(&mut self, shape: Shape, cutoff: Option<UomRatio>, sigma: Option<Time>) {
...
pub fn lor_weights(lor: LOR, fov: FOV, shape: Shape, cutoff: Option<UomRatio>, sigma: Option<Time>) {
