use crate::types::{Length, PerLength, UomRatio, Time, UOM_TWOPI, UOM_C};
...
pub fn make_gauss_option(sigma: Option<Time>, cutoff: Option<UomRatio>) -> Option<impl Fn(Length) -> PerLength> {
